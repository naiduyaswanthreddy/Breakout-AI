...
GMAIL_USER = 'reddyy356@gmail.com'  # Gmail account
GMAIL_PASSWORD = 'Y@$hu@2004'
 # Gmail password (App Password recommended)
GROQ_API_KEY = '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'  # Groq API Key
